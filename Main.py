...
class Sudoku:
    ...
    def fill_empty(self, number, row, column):
        ...
        for new_number in range(number+1, 10):
            ...
            if self.check_row(new_number, row) and self.check_column(new_number, column) and self.check_square(new_number, row,
                                                                                                       column):
